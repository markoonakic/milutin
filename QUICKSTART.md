...
> ⚠️ **IMPORTANT:** Always open Claude Code in the configuration repository (`milutin/`), **not** in your Obsidian vault. The agents and commands are defined in the milutin repo and must be loaded from there.
...
```
Can you help me create a permanent note about [idea] in the Zettelkasten/ folder?
```
