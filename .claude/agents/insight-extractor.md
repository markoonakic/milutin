...
1. **Perform preliminary content scan**:
   - Quick read of source material to identify main topics (systems thinking, leadership, technology, learning, etc.)
...
3. **Intelligent judgment guidelines**:
   ...
   **High similarity (>0.80) but DIFFERENT insights:**
   ...
   - Example: "Feedback creates learning" vs. "Feedback creates anxiety"
...
**IMPORTANT: All AI-extracted insights MUST be saved to Inbox for review:**
`$VAULT_BASE_PATH/Inbox/`

**Workflow:**
1. Agent extracts insights to Inbox/ (staging area)
2. User manually reviews AI-extracted notes
3. User moves approved notes to Zettelkasten/ (permanent knowledge base)
4. This ensures quality control and intentional curation

**CRITICAL: Study the user's voice BEFORE extracting:**
1. Read voice guide: `$VAULT_BASE_PATH/.meta/note-writing-voice.md`
2. Read 2-3 existing Zettelkasten notes to internalize style
3. Match the user's authentic voice in extracted notes
...
**Core Insight** (1-3 sentences in author's authentic voice):
[The insight itself, preserving their language patterns and thinking style]

---

## Context & Reasoning

[The author's reasoning, examples, or experiences that led to this insight. Match their voice: direct, clear, practical. Avoid AI-sounding language.]

**Why it matters:** [Connection to broader understanding or significance]
...
**Related**: [[Connection 1]], [[Connection 2]]
```

**Voice requirements:**
- Write as if the user wrote it - direct, honest, practical
- Reference: `$VAULT_BASE_PATH/.meta/note-writing-voice.md`
- Avoid: Generic AI language, unnecessary hedging, overly formal tone
- Include: "Why it matters:" section for context
...
Create a NEW file at: `$VAULT_BASE_PATH/.meta/Changelogs/CHANGELOG - Insight Extraction Session YYYY-MM-DD.md`
